...
@(require (for-label racket/base
                     racket/class
                     syntax-color/classified-text
                     syntax-color/racket-indentation
                     syntax-color/racket-navigation
                     framework))

@(define-syntax-rule (explain-classified text)
   @list{Although @racket[text] is not required to be an instance of
   @racket[classified-text<%>], the @racket[classified-text<%>] interface
   describes the methods that might be used.})

@title{Racket S-Expression Indentation and Navigation}
...
with any object that implements the same methods as
@racket[classified-text<%>].
...
@deftogether[(
@defproc[(racket-forward-sexp [text object?]
                              [pos exact-nonnegative-integer?])
         (or/c #f exact-nonnegative-integer?)]
@defproc[(racket-backward-sexp [text object?]
                               [pos exact-nonnegative-integer?])
         (or/c #f exact-nonnegative-integer?)]
@defproc[(racket-up-sexp [text object?]
                         [pos exact-nonnegative-integer?])
         (or/c #f exact-nonnegative-integer?)]
@defproc[(racket-down-sexp [text object?]
                           [pos exact-nonnegative-integer?])
         (or/c #f exact-nonnegative-integer?)]
)]{
...
@explain-classified[text]}

@defproc[(racket-stick-to-next-sexp? [text object?]
                                     [pos exact-nonnegative-integer?])
         boolean?]{
...
@defproc[(racket-amount-to-indent [text object?]
                                  [pos exact-nonnegative-integer?]
                                  ...
                                  [#:graphical-width graphical-width
                                                     (or/c #f (object? exact-nonnegative-integer?
